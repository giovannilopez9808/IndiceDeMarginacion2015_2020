"""
Clase que contiene la estructura para la ejecuccion del algoritmo SOM para diferentes datos dado el número de componentes y perplejidad
"""
...
class SOM_model:
    ...
    def _create(self) -> None:
        """
        Inicializa el algoritmo SOM dado el numero de componentes y el nombre del kernel
        """
        self.model = SOM(n_rows=1, n_columns=5)
        self._generate_header_name()

    def run(self, data: array) -> None:
        """
        Ejecuta el algoritmo SOM dado un embedding
        """
